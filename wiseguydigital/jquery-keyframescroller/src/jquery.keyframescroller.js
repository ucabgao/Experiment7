    ...
    $.keyframescroller = function (options) {
        ...
        keyframescroller.swipeNav = function (event, direction) {
            ...
            switch (direction) {
                // Down
                case 'down':
                    if (keyframescroller.settings.orientation == 'horizontal')
                        return;
                    if (keyframescroller.curKeyframe == keyframescroller.settings.totalKeyframes - 1)
                        return;
                ...
                case 'up':
                    if (keyframescroller.settings.orientation == 'horizontal')
                        return;
                    if (keyframescroller.curKeyframe == 0)
                        return;
                    newKey = keyframescroller.curKeyframe - 1;
                    break;
                // Right
                case 'right':
                    if (keyframescroller.settings.orientation == 'vertical')
                        return;
                    if (keyframescroller.curKeyframe == 0)
                        return;
                    newKey = keyframescroller.curKeyframe - 1;
                ...
                case 'left':
                    if (keyframescroller.settings.orientation == 'vertical')
                        return;
                    if (keyframescroller.curKeyframe == keyframeScroll.settings.totalKeyframes - 1)
                        return;
                    newKey = keyframescroller.curKeyframe + 1;
                    break;
            }
